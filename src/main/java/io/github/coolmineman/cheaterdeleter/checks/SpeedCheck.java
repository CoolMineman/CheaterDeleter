...
public class SpeedCheck extends Check
    ...
    public ActionResult onMovementPacket(CDPlayer player, PlayerMoveC2SPacketView packet) {
        ...
        if (packet.isChangePosition() || !(player.mcPlayer.isCreative() || System.currentTimeMillis() - TrackerManager.get(PlayerLastTeleportData.class, player).lastTeleport < 3000 || CollisionUtil.isNearby(player, 2, 4, CollisionUtil.SPLIPPERY))) {
